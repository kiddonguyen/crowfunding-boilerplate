  ...
  return (
    <div className="relative">
      <input
        ...
        className={`w-full py-4 px-6 border bg-transparent rounded-xl text-sm font-medium
        text-text1 placeholder:text-text4 dark:placeholder:text-text2 dark:text-white ${
          error.length > 0
